...
image_path="Tropical beach  wallpaper desktop laptop background 4k HD 1080p Blue Ocean Palm tree travel images.jpeg"
...
plt.title("Annotated Image with Regions, Centers, and Bi_Directional Height Arrow")
plt.axis("off")
plt.show()